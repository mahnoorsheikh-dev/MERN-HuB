...
export default function FooterLinks() {
  ...
  const topicLinks = [
    ...
    { name: "Express.js", href: "/express" },
    { name: "React.js", href: "/react" },
    { name: "MongoDB", href: "/mongo" },
  ...
  return (
    <div className="bg-[#1E1E2F] text-[#E0E0E0] border-t border-[#00BFA6]">
      <div className="max-w-6xl mx-auto px-6 md:px-16 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <h3 className="text-xl font-semibold text-[#00BFA6] mb-4">
            Navigation
          </h3>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="#" className="hover:text-[#00BFA6] transition-colors">
              <Twitter size={20} />
            </a>
      ...
      <div className="flex items-center gap-2 text-sm text-[#888888] justify-end px-6 md:px-16 py-4">
            <span>Language:</span>
